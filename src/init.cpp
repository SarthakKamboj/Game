...
void init_sdl(application_t& app) {
	...
	if (app.is_full_screen) {
		...
		window = SDL_CreateWindow("Night Run", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, STARTING_WINDOW_WIDTH, STARTING_WINDOW_HEIGHT, SDL_WINDOW_SHOWN | SDL_WINDOW_OPENGL | SDL_WINDOW_RESIZABLE);
	}
